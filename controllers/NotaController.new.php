...
class NotaController extends \BaseController {
	...
	public function getIndex()
	{
		...
		$nomeProva = DB::table('provas')->where('id', '=', $prova->prova_id)->pluck('nome');	
                ...
                $notas = $notas->with('inscricao.usuario')
	                     ->Where('prova_id', $id_identificador)
	        			 ->get();
        ...
        return  View::make('painel_professor.notas.index', compact('prova', 'nomeProva', 'notas', 'areas_usuario', 'situacoes', 'periodos','periodo_id', 'identificadorNome', 'id_identificador'));
	...
	public function getExportarNotas()
	{
        ...
        if($periodo) {
			...
			fputcsv($output, array('Linha', 'Candidato', 'PE', 'PO', 'PT', 'PP', 'Status'),';');
...
// 									foreach($inscricao->provas_doutorado as $notas_doutorado)
// 									{
// 										if($notas_doutorado->area_id == $area_doutorado->id)
// 										{
											
// 											if (strcmp($prova_doutorado->identificador, "PE") == 0)
// 											{
// 												$notas[0] = $prova_doutorado->pivot->nota;
// 											}
// 											elseif (strcmp($prova_doutorado->identificador, "PO") == 0)
// 											{
// 												$notas[1] = $prova_doutorado->pivot->nota;
// 											}
// 											elseif (strcmp($prova_doutorado->identificador, "PT") == 0)
// 											{
// 												$notas[2] = $prova_doutorado->pivot->nota;
// 											}
// 											elseif (strcmp($prova_doutorado->identificador, "PP") == 0)
// 											{
// 												$notas[3] = $prova_doutorado->pivot->nota;
// 											}
// 										}
// 									}
// 									$array = array_merge($array, $notas);
