            ...
            <ul class="nav-right pull-right list-unstyled">
                ...
                <li class="dropdown langs text-normal" data-ng-controller="LangCtrl">
                    ...
                    <ul class="dropdown-menu with-arrow pull-right list-langs" role="menu">
                        ...
                        <li data-ng-show="lang !== 'Portugal' ">
                            <a href="javascript:;" data-ng-click="setLang('Portugal')"><div class="flag flags-portugal"></div> Português</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="dropdown text-normal nav-profile">
                    ...
                    <ul class="dropdown-menu with-arrow pull-right">
                        ...
                        <li>
                            <a href="@if(Session::has('is_professor') && Session::get('is_professor') == false) {{URL::to('candidato/meusdados/dados-pessoais')}} @else {{URL::to('professor/meusdados/dados-pessoais')}} @endif">
                                <i class="fa fa-user"></i>
