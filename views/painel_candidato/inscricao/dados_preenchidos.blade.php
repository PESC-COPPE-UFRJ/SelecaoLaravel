...
<!-- <form class="form-horizontal ng-pristine ng-valid outrasinfos" role="form" method="POST" action="candidato/doutorado/candidatarse"> -->
    ...
    <section class="panel panel-default">
        ...
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> Dados Preenchidos</strong></div>

        <div class="panel-body">

            <div class="row">
                <div class="col-sm-9">
                    Impressão somente para conferência. <strong>ESTE DOCUMENTO NÃO É VÁLIDO PARA INSCRIÇÃO.</strong>
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <!-- <a class="btn btn-warning" target="_blank" href="candidato/inscricao/dados-pdf?tipo={{ $tipo }}"><span class="glyphicon glyphicon-print"></span> &nbsp;.pdf</a> -->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1 align="right">Lista de dados para candidatura "Seleção @if(isset($periodo)){{$periodo->ano}}/{{$periodo->periodo}}@endif"</h1>
                    <h3 align="right">Este documento não é válido para inscrição!</h3>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5" id="meusdados">
                    {{--@if(isset($candidato))--}}
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Foto</td>
                                <td>
                                    {? #$src = 'images/assets/no-photo.png'; ?}
                                    @if($candidato->foto != '')
                                        {? #$src = $candidato->foto ?}
                                    @endif
                ...
                <div class="col-sm-1">
                    <table style="width: 3px; height: 700px;" align="center" id="separador">
                        <tr>
