    ...
    <section class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <p><img src="/images/logo.png" alt="PESC" title="PESC" /></p>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                                                ...
                                                <td>
                                                    ...
                                                    @foreach($inscricao->provas_mestrado as $prova_mestrado)                                                        
                                                        @if($prova_mestrado->area_id == $area_mestrado->id)                                                
                                                            <tr>
                                                                <td>{{ $prova_mestrado->identificador }}</td>
                                                                <td>{{ $prova_mestrado->prova->nome }}</td>
                                                                <td>{{ $prova_mestrado->pivot->nota }}</td>
                        ...
                        @else
                            <tr>
                                <td>Sem inscrições com notas para a área escolhida!</td>
                            </tr>
                        @endif
                                                ...
                                                <td>
                                                    ...
                                                    @foreach($inscricao->provas_doutorado as $provas_doutorado)
                                                        ...
                                                        @if($provas_doutorado->area_id == $area_doutorado->id)                                                
                                                            ...
                                                            @endif                                                        
                                                            <tr>
                                                                <td>{{ $provas_doutorado->identificador }}</td>
                                                                <td>{{ $provas_doutorado->prova->nome }}</td>
                                                                <td>{{ $provas_doutorado->pivot->nota }}</td>
