                                ...
                                @foreach($periodo->areas_mestrado_get as $area_mestrado)
                                    ...
                                    @if($area_mestrado->area_id == $area->id)
                                        ...
                                        <div class="form-group div_prova_mestrado_{{$prova_mestrado->area_id}}_{{$i}}">
                                            <div class="row">
                                                <label class="col-md-1 control-label"><button type="button" class="btn btn-danger prova_mestrado" areaid="{{$prova_mestrado->area_id}}" prova_i="{{$i}}" prova_id="0" periodo_id="{{$periodo->id}}" areasigla="BD">Deletar</button></label>
                                                <label class="col-md-2 control-label">Identificador:</label>
                                            ...
                                            <div class="row">
                                                <label class="col-md-3 control-label" for="selectbasic">Tipo da Prova:</label>
                                                <div class="col-md-3">
                                                    <select id="selectbasic" areaid="1" prova_i="0" name="provas_mestrado[{{$prova_mestrado->area_id}}][{{$i}}][tipo]" class="form-control tipo_mestrado">
                                                        <option>Selecione uma opção</option>
                                                ...
                                                <label class="col-md-3 control-label tipo_mestrado_eliminatoria1-0" for="selectbasic" @if($prova_mestrado->tipo == 'Classificatoria') style="display: none;" @endif>Nota Eliminatória:</label>
                                                <div class="col-md-3 tipo_mestrado_eliminatoria1-0" @if($prova_mestrado->tipo == 'Classificatoria') style="display: none;" @endif>
                                                ...
                                                <label class="col-md-3 control-label tipo_mestrado_classificatoria1-0" for="selectbasic" @if($prova_mestrado->tipo == 'Eliminatoria') style="display: none;" @endif>Nota Classificatória:</label>
                                                <div class="col-md-3 tipo_mestrado_classificatoria1-0" @if($prova_mestrado->tipo == 'Eliminatoria') style="display: none;" @endif>
                                ...
                                @foreach($periodo->areas_doutorado_get as $area_doutorado)
                                    ...
                                    @if($area_doutorado->area_id == $area->id)
                                        ...
                                        <div class="form-group div_prova_doutorado_{{$prova_doutorado->area_id}}_{{$i}}">
                                            <div class="row">
                                                <label class="col-md-1 control-label"><button type="button" class="btn btn-danger prova_doutorado" areaid="{{$prova_doutorado->area_id}}" prova_i="{{$i}}" prova_id="0" periodo_id="{{$periodo->id}}" areasigla="BD">Deletar</button></label>
                                                <label class="col-md-2 control-label">Identificador:</label>
                                            ...
                                            <div class="row">
                                                <label class="col-md-3 control-label" for="selectbasic">Tipo da Prova:</label>
                                                <div class="col-md-3">
                                                    <select id="selectbasic" areaid="1" prova_i="0" name="provas_doutorado[{{$prova_doutorado->area_id}}][{{$i}}][tipo]" class="form-control tipo_doutorado">
                                                        <option>Selecione uma opção</option>
                                                ...
                                                <label class="col-md-3 control-label tipo_doutorado_eliminatoria1-0" for="selectbasic" @if($prova_doutorado->tipo == 'Classificatoria') style="display: none;" @endif>Nota Eliminatória:</label>
                                                <div class="col-md-3 tipo_doutorado_eliminatoria1-0" @if($prova_doutorado->tipo == 'Classificatoria') style="display: none;" @endif>
                                                ...
                                                <label class="col-md-3 control-label tipo_doutorado_classificatoria1-0" for="selectbasic" @if($prova_doutorado->tipo == 'Eliminatoria') style="display: none;" @endif>Nota Classificatória:</label>
                                                <div class="col-md-3 tipo_doutorado_classificatoria1-0" @if($prova_doutorado->tipo == 'Eliminatoria') style="display: none;" @endif>
...
<script type="text/javascript">
    $(function() { 
        $("#title_text").html("Clonando Período {{$periodo->ano}}.{{$periodo->periodo}}");

        $("#ano").change(function(){
            var ano = $(this).val();
            var periodo = $("#periodo").val();
            if(ano != ''){
                $("#title_text").html("Clonando Período "+ano+"."+periodo);
            } else {
                $("#title_text").html("Clonando Período");
            }
        });
        ...
        $("#steps-uid-0-t-1").click(function(){
            ...
            var periodo = $("#periodo").val();
            if(ano != ''){
                $("#title_text").html("Clonando Período "+ano+"."+periodo+" - Mestrado");
            } else {
                $("#title_text").html("Clonando Período - Mestrado");
            }
        });
        $("#steps-uid-0-t-2").click(function(){
            ...
            var periodo = $("#periodo").val();
            if(ano != ''){
                $("#title_text").html("Clonando Período "+ano+"."+periodo+" - Doutorado");
            } else {
                $("#title_text").html("Clonando Período - Doutorado");
            }
        });
        $("#next").click(function(){
            var ano = $("#ano").val();
